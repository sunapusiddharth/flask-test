...
def processJournalsInFolder(folder_path):
    # Walks through folder ,processes the files and inserts them into mongoDB.
            ...
            with open(filename) as xml_file:
                ...
                try:
                    ...
                    try:
                        ...
                        print("Error occured for filename",filename,error)

            xml_file.close()


# Multithreading to make program faster:
if __name__ == "__main__": 
    t1=threading.Thread(target=processJournalsInFolder,args=('D:\datasets\HindawiArticles\\2008',))
    t2=threading.Thread(target=processJournalsInFolder,args=('D:\datasets\HindawiArticles\\2009',))
    t3=threading.Thread(target=processJournalsInFolder,args=('D:\datasets\HindawiArticles\\2010',))
